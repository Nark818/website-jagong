...
import { CAT_LABEL, TAG_CLASSES, type Category } from "@/lib/news";
import { formatIndonesianDate } from "@/lib/format";
import type { getNewsPosts } from "@/lib/supabase/queries";
...
export function BeritaBrowser({ posts }: { posts: NewsPost[] }) {
